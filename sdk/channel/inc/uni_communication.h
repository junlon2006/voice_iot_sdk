 ...
 *
 **************************************************************************/
#ifndef SDK_CHANNEL_INC_UNI_COMMUNICATION_H_
#define SDK_CHANNEL_INC_UNI_COMMUNICATION_H_
...
typedef struct {
  ...
  void* (*malloc_fn)(size_t size);             /* malloc hook */
  void  (*free_fn)(void *ptr);                 /* free hook */
  void* (*realloc_fn)(void *ptr, size_t size); /* realloc hook */
...
#endif
#endif  // SDK_CHANNEL_INC_UNI_COMMUNICATION_H_